...
\begin{rSection}{Publications}
	\begin{rSubsection}{(Pre-print) Algebraic aspects and functoriality of the set of affiliated operators}{2023}{with S. Nayak}{}
...
\begin{rSection}{CONTRIBUTED TALKS}
	...
	\begin{rSubsection}{Young Mathematicians in Operator Algebras}{Feb 27, 2024}{Indian Statistical Institute Delhi}{Delhi, India}
		\item Place: Stat-Math Unit, ISI 
		\item Website: \weblink{https://sites.google.com/view/ymoa/home}
	\end{rSubsection}
	
	\begin{rSubsection}{Workshop on Completely Positive Maps}{Jan 15 - Apr 29, 2024}{Indian Statistical Institute Bangalore}{Bangalore, India}
		\item Place: Stat-Math Unit, ISI 
		\item Website: \href{https://indrajitghosh.onrender.com/teaching/isibc/intro_to_cp_even_2024.html}{link here}
	\end{rSubsection}
...
\begin{rSection}{CONFERENCES AND WORKSHOPS ATTENDED}
	...
	\begin{rSubsection}{Young Mathematicians in Operator Algebras}{Feb 26 - Mar 02, 2024}{Indian Statistical Institute, Delhi}{Delhi, India}
		\item Place: Stat-Math Unit, ISI Delhi 
		\item Website: \weblink{https://sites.google.com/view/ymoa/home}
	\end{rSubsection}
